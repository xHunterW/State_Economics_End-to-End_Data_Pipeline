1. Navigate to the Team2_FinalProject directory in the terminal.
2. Run the following command to create the Docker image and container: docker-compose up. (Note: ensure docker container jhu_docker is not running)
3. After the installation is complete, a shared folder will appear within the Team2_FinalProject directory.
4. Place FinalProject.ipynb and finalprojectapi.py in the shared folder
5. Place finalprojectpandasprofiling.py and final project cleaning & upload dag 1.py in the  Team2_FinalProject/shared/airflow/dags folder
6. Create Team2_FinalProject/shared/airflow/dags/data folder
7. Place the following files in the Team2_FinalProject/shared/airflow/dags/data folder: SAGDP2N__ALL_AREAS_1997_2020.csv, Minimum Wage Data.csv, nces330_20.csv, UnemploymentReport.xlsx
...
12. Run the generate_pandas_reports DAG to generate HTML profile reports for each table/dataset. The reports will be found in the Team2_FinalProject/shared folder. 
